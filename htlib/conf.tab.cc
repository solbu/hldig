...
/*  A Bison parser, made from ../../htdig3/htlib/conf.y
...
static const char * const yytname[] = {   "$","error","$undefined.","NUM","T_DELIMITER",
"T_NEWLINE","T_RIGHT_BR","T_LEFT_BR","T_SLASH","T_STRING","T_KEYWORD","T_NUMBER",
"input","block","simple_expression","complex_expression","simple_expression_list",
"list", NULL
};
#endif
...
case 2:
#line 38 "../../htdig3/htlib/conf.y"
{ /* Whole config file */ ;
    break;}
case 3:
#line 41 "../../htdig3/htlib/conf.y"
{   
  // name: value
...
#line 82 "../../htdig3/htlib/conf.y"
{
    ...
    break;}
case 9:
#line 90 "../../htdig3/htlib/conf.y"
{ /* Ignore empty lines */  ;
    break;}
case 10:
#line 93 "../../htdig3/htlib/conf.y"
{
