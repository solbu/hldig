...
///////
  ...
  virtual HtDateTime *GetModificationTime () const
  {
    return _modification_time;
  }

  // Get the access time object pointer
  virtual HtDateTime *GetAccessTime () const
  {
    return _access_time;
  }
  ...
  virtual int GetDocumentLength () const
  {
    return _document_length;
  }
  ...
  virtual const String & GetReasonPhrase ()
  {
    return _reason_phrase;
  }

  // Get the location (redirect)
  virtual const String & GetLocation ()
  {
    return _location;
  }
...
///////
  ...
  const HtDateTime *GetStartTime () const
  {
    return &_start_time;
  }
  const HtDateTime *GetEndTime () const
  {
    return &_end_time;
  }
  ...
  void SetWaitTime (unsigned int t)
  {
    _wait_time = t;
  }
  ...
  virtual String GetCredentials ()
  {
    return _credentials;
  }

  // Proxy settings
  virtual void SetProxy (int aUse)
  {
    _useproxy = aUse;
  }
  ...
  {
    _proxy_credentials = s;
  }
  virtual String GetProxyCredentials ()
  {
  ...
  HtDateTime *GetRequestModificationTime ()
  {
    return _modification_time;
  }

  // Get and set the max document size to be retrieved
  void SetRequestMaxDocumentSize (int s)
  {
    _max_document_size = s;
  }
  int GetRequestMaxDocumentSize () const
  {
    return _max_document_size;
  }
...
///////
  ...
  {
    return _connection ? _connection->IsConnected () : 0;
  }
...
// Get statistics info
  static int GetTotOpen ()
  {
    return _tot_open;
  }
  static int GetTotClose ()
  {
    return _tot_close;
  }
  static int GetTotServerChanges ()
  {
    return _tot_changes;
  }
...
protected:
  ...
  static void SetHTTPBasicAccessAuthorizationString (String & dest,
                                                     const String & s);
