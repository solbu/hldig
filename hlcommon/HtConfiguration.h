...
public:
  ...
  void Add (const char *name, const char *value, Configuration * aList);
  const String Find (URL * aUrl, const char *value) const;
  const String Find (const char *blockName, const char *name,
  ...
  inline String ParseString (const char *) const;       // parse ${var} string
...
HtConfiguration ():Configuration ()
  ...
  HtConfiguration (const HtConfiguration & config):Configuration (config),
    dcBlocks (config.dcBlocks), dcUrls (config.dcUrls)
  {
    ;
  }
...
//********************************************************************
//
inline String HtConfiguration::ParseString (const char *str) const
{
