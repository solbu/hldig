...
2. [Fork the repo](https://github.com/andy5995/hldig#fork-destination-box) (if you haven't already done so)
...
1. [Configuring a remote for a fork](https://help.github.com/articles/configuring-a-remote-for-a-fork/)
    * For step 3 on that page, use https://github.com/andy5995/hldig for the URL.
