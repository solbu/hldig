...
//
// $Id: libhtdig_htsearch.cc,v 1.1 2003/04/09 00:50:36 nealr Exp $
//
//----------------------------------------------------------------
...
int htsearch_query(htsearch_query_struct * htseach_query)
{
    ...
    //{
        ...
        collection = new Collection((char *) configFile,
                                        word_db.get(), doc_index.get(), doc_db.get(),
                                        doc_excerpt.get());
...
//
void
setupWords(char *allWords, List & searchWords, int boolean, Parser * parser, String & originalPattern)
{
