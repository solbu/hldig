...
extern "C"
{
                                        ...
                                        int *outbuff_lengthp, void *user_data)
  {
    ...
    return ((WordDBCompress *) user_data)->Compress ((unsigned char *) inbuff,
                                                     inbuff_length,
                                                     (unsigned char **)
                                                     outbuffp,
                                                     outbuff_lengthp);
                                          ...
                                          int outbuff_length, void *user_data)
  {
    ...
    return ((WordDBCompress *) user_data)->
      Uncompress ((unsigned char *) inbuff, inbuff_length,
                  (unsigned char *) outbuff, outbuff_length);
  }
                          ...
                          uint8_t ** outbuffp, int *outbuff_lengthp)
{
  ...
  {
    printf
      ("###########################  WordDBCompress::Compress:  #################################################\n");
    pg.show ();
    printf ("~~~~~~~~~~~~~\n");
  }

  if (debug)
    TestCompress (inbuff, inbuff_length);
  ...
  if (debug > 2)
    printf
      ("WordDBCompress::Compress: final output size:%6d (inputsize:%6d)\n",
                            ...
                            uint8_t * outbuff, int outbuff_length)
{
  ...
  if (debug > 2)
    printf ("------------------------  WordDBCompress::Uncompress: END\n");
