...
public:
  ...
  //
  int Insert (const WordReference & wordRef)
  {
    return Put (wordRef, DB_NOOVERWRITE);
  }
  //-
  ...
  // Returns OK on success, NOTOK on error.
  //
  int Override (const WordReference & wordRef)
  {
    return Put (wordRef, 0);
  }
#ifndef SWIG
  ...
  {
    return db.Exists (wordRef) == 0 ? OK : NOTOK;
  }
#ifndef SWIG
  //-
  ...
  {
    return Exists (WordReference (word));
  }
#endif /* SWIG */
  ...
  %name (DeleteCursor)
    ...
    // a <b>WordCursor.</b> 
    //
  int Delete (WordDBCursor & cursor)
  {
    return cursor.Del ();
  }
  ...
  // header for usage.
  //
  List *Find (const WordReference & wordRef)
  {
    return (*this)[wordRef];
  }
  //-
  ...
  // header for usage.
  //
  List *FindWord (const String & word)
  {
    return (*this)[word];
  }
#ifndef SWIG
  ...
  //
  List *operator [] (const String & word)
  {
    return (*this)[WordReference (word)];
  }
#endif /* SWIG */
  //-
  ...
  {
    return this->Prefix (WordReference (prefix));
  }
#endif /* SWIG */
  ...
  //
  WordCursor *Cursor (wordlist_walk_callback_t callback,
                      Object * callback_data)
  {
    return new WordCursor (this, callback, callback_data);
  }
#endif /* SWIG */
  //- 
  // Create a cursor that searches all the occurrences in the
  ...
  //
  WordCursor *Cursor (const WordKey & searchKey, int action =
                      HTDIG_WORDLIST_WALKER)
  {
    return new WordCursor (this, searchKey, action);
  }
#ifndef SWIG
  //-
  // Create a cursor that searches all the occurrences in the
  ...
  //
  WordCursor *Cursor (const WordKey & searchKey,
                      wordlist_walk_callback_t callback,
                      Object * callback_data)
  {
    return new WordCursor (this, searchKey, callback, callback_data);
  }
#endif /* SWIG */
  ...
  //
  WordDBCompress *GetCompressor ()
  {
    return compressor;
  }
  void SetCompressor (WordDBCompress * compressor_arg)
  {
    compressor = compressor_arg;
  }
