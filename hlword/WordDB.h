...
public:
  ...
  // String arguments
  //
  inline int Put (DB_TXN * txn, const String & key, const String & data,
                  int flags)
  {
  ...
  //
  inline DB_CMPR_INFO *CmprInfo ()
  {
    return dbenv->mp_cmpr_info;
  }
  inline void CmprInfo (DB_CMPR_INFO * info)
  {
    dbenv->mp_cmpr_info = info;
  }
