...
///////
  ...
  // Get Connection info
  const String & GetConnectionInfo () const
  {
    return _hdrconnection;
  }

  // Get Content language
  const String & GetContentLanguage () const
  {
...
private:
  HtHTTP ()
  {
  }                             // Declared private - avoids default constructor to be created
...
///////
  ...
  void SetRequestMethod (Request_Method rm)
  {
    _Method = rm;
  }
  ...
  void SetRequestURL (const URL & u)
  {
    _url = u;
  }
  URL GetRequestURL ()
  ...
  void SetRefererURL (const URL & u)
  {
    _referer = u;
  }
  URL GetRefererURL ()
  ...
  void SetAcceptLanguage (const String & al)
  {
    _accept_language = al;
  }
  URL GetAcceptLanguage ()
  {
  ...
  static void SetRequestUserAgent (const String & s)
  {
    _user_agent = s;
  }
  static const String & GetRequestUserAgent ()
  {
    return _user_agent;
  }
...
///////
  ...
  // Is allowed
  bool isPersistentConnectionAllowed ()
  {
    return _persistent_connection_allowed;
  }

  // Is possible
  bool isPersistentConnectionPossible ()
  {
    return _persistent_connection_possible;
  }
  ...
  void AllowPersistentConnection ()
  {
    _persistent_connection_allowed = true;
  }

  // Disable Persistent Connection
  void DisablePersistentConnection ()
  {
    _persistent_connection_allowed = false;
  }
...
///////
  ...
  static void SetCookieJar (HtCookieJar * cj)
  {
    _cookie_jar = cj;
  }
...
///////
  ...
  static int GetTotSeconds ()
  {
    return _tot_seconds;
  }

  static int GetTotRequests ()
  {
    return _tot_requests;
  }

  static int GetTotBytes ()
  {
    return _tot_bytes;
  }
...
///////
  ...
  {
    _head_before_get = true;
  }
  static void DisableHeadBeforeGet ()
  {
    _head_before_get = false;
  }

  static bool HeadBeforeGet ()
  {
    return _head_before_get;
  }
...
///////
  ...
  static void SetParsingController (int (*f) (char *))
  {
    CanBeParsed = f;
  }
...
///////
  ...
  void SetBodyReadingController (int (HtHTTP::*f) ())
  {
    _readbody = f;
  }
  int ReadBody ();
