...
//
// $Id: Dictionary.cc,v 1.1.2.1 2006/09/25 23:50:30 aarnone Exp $
//
...
DictionaryEntry::~DictionaryEntry()
{
    ...
    debug->outlog(10, "DictionaryEntry destructor start\n");

    free(key);
    delete value;

    debug->outlog(10, "DictionaryEntry destructor done\n");
}
