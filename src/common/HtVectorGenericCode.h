...
//
// $Id: HtVectorGenericCode.h,v 1.1.2.1 2006/09/25 23:50:31 aarnone Exp $
//
...
HtVectorGType::~HtVectorGType()
{
  ...
  debug->outlog(10, "HtVectorGType destructor start\n");

  Destroy();

  debug->outlog(10, "HtVectorGType destructor done\n");
}
