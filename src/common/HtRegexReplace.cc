...
//
// $Id: HtRegexReplace.cc,v 1.1.2.1 2006/09/25 23:50:30 aarnone Exp $
//
...
HtRegexReplace::~HtRegexReplace()
{
    ...
    debug->outlog(10, "HtRegexReplace destructor start\n");

	empty();

    debug->outlog(10, "HtRegexReplace destructor done\n");
}
