...
int CDB___os_strdup __P((DB_ENV *, const char *, void *));
int CDB___os_calloc __P((DB_ENV *, size_t, size_t, void *));
int CDB___os_malloc __P((DB_ENV *, size_t, void *(*)(size_t), void *));
int CDB___os_realloc __P((DB_ENV *,
...
int CDB___os_dirlist __P((DB_ENV *, const char *, char ***, int *));
...
int CDB___os_finit __P((DB_ENV *, DB_FH *, size_t, int));
int CDB___os_fpinit __P((DB_ENV *, DB_FH *, db_pgno_t, int, int));
int CDB___os_fsync __P((DB_ENV *, DB_FH *));
int CDB___os_openhandle __P((DB_ENV *, const char *, int, int, DB_FH *));
...
int CDB___os_open __P((DB_ENV *, const char *, u_int32_t, int, DB_FH *));
int CDB___os_r_attach __P((DB_ENV *, REGINFO *, REGION *));
int CDB___os_r_detach __P((DB_ENV *, REGINFO *, int));
int CDB___os_rename __P((DB_ENV *, const char *, const char *));
int CDB___os_isroot __P((void));
char *CDB___db_rpath __P((const char *));
int CDB___os_io __P((DB_ENV *, DB_IO *, int, size_t *));
int CDB___os_read __P((DB_ENV *, DB_FH *, void *, size_t, size_t *));
int CDB___os_write __P((DB_ENV *, DB_FH *, void *, size_t, size_t *));
int CDB___os_seek __P((DB_ENV *,
     DB_FH *, size_t, db_pgno_t, u_int32_t, int, DB_OS_SEEK));
int CDB___os_sleep __P((DB_ENV *, u_long, u_long));
int CDB___os_spin __P((void));
void CDB___os_yield __P((DB_ENV*, u_long));
int CDB___os_exists __P((const char *, int *));
int CDB___os_ioinfo __P((DB_ENV *, const char *,
   DB_FH *, u_int32_t *, u_int32_t *, u_int32_t *));
int CDB___os_tmpdir __P((DB_ENV *, u_int32_t));
int CDB___os_unlink __P((DB_ENV *, const char *));
#if defined(_WIN32)
