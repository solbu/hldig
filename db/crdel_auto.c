...
int
CDB___crdel_fileopen_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
...
int
CDB___crdel_fileopen_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__crdel_fileopen_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__crdel_fileopen_args) +
...
int
CDB___crdel_metasub_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___crdel_metasub_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___crdel_metasub_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__crdel_metasub_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__crdel_metasub_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___crdel_metapage_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
...
int
CDB___crdel_metapage_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__crdel_metapage_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__crdel_metapage_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___crdel_old_delete_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___crdel_old_delete_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___crdel_old_delete_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__crdel_old_delete_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__crdel_old_delete_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int CDB___crdel_rename_log(dbenv, txnid, ret_lsnp, flags,
	fileid, name, newname)
	DB_ENV *dbenv;
	DB_TXN *txnid;
	DB_LSN *ret_lsnp;
...
int
CDB___crdel_rename_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
...
int
CDB___crdel_rename_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__crdel_rename_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__crdel_rename_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___crdel_delete_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
...
int
CDB___crdel_delete_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__crdel_delete_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__crdel_delete_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
	...
	DB_ENV *dbenv;
{
	...
	if ((ret = CDB___db_add_recovery(dbenv,
		...
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___crdel_old_delete_print, DB_crdel_old_delete)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___crdel_rename_print, DB_crdel_rename)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	...
	DB_ENV *dbenv;
{
	...
	if ((ret = CDB___db_add_recovery(dbenv,
		...
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___deprecated_recover, DB_crdel_old_delete)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___crdel_rename_recover, DB_crdel_rename)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
