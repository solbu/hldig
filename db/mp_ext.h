...
void CDB___memp_mf_discard __P((DB_MPOOL *, MPOOLFILE *));
...
int CDB___memp_cmpr_deflate __P((DB_ENV *, const u_int8_t *, int, u_int8_t **, int*, void *));
u_int8_t CDB___memp_cmpr_coefficient __P((DB_ENV *dbenv));
int CDB___memp_cmpr_create __P((DB_ENV *, DB_FH *, size_t, int));
int CDB___memp_cmpr_open __P((DB_ENV *, MPOOLFILE *, const char *));
int CDB___memp_cmpr_close __P((DB_ENV *, DB_MPOOLFILE *));
int CDB___memp_cmpr_alloc __P((DB_MPOOLFILE *, db_pgno_t *, size_t, BH *, int *));
