...
#ifndef lint
static const char revid[] = "$Id: env_method.c,v 1.1.2.2 2000/09/14 03:13:20 ghutchis Exp $";
#endif /* not lint */
	...
	u_int32_t flags;
{
	...
	if ((ret = CDB___os_calloc(NULL, 1, sizeof(*dbenv), &dbenv)) != 0)
		return (ret);
...
#define	DATA_INIT_CNT	20			/* Start with 20 data slots. */
	if (dbenv->db_data_dir == NULL) {
		if ((ret = CDB___os_calloc(dbenv, DATA_INIT_CNT,
	...
	const char *dir;
{
	...
	return (CDB___os_strdup(dbenv, dir, &dbenv->db_tmp_dir));
}
	...
	u_int32_t flags;
{
	...
	CDB___db_err(dbenv, "set_server method meaningless in non-RPC enviroment");
