...
static void CDB___dbenv_set_errcall
__P ((DB_ENV *, void (*)(const char *, char *)));
...
__P ((DB_ENV *, void (*)(DB_ENV *, int, int)));
...
static void CDB___dbenv_set_paniccall
...
{
  CDB___db_err (dbenv,
                "%s: method meaningless %s open", name,
                after ? "after" : "before");
  return (EINVAL);
}
