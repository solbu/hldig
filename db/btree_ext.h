...
int CDB___bam_rsplit_recover __P ((DB_ENV *, DBT *, DB_LSN *, int, void *));
int CDB___bam_adj_recover __P ((DB_ENV *, DBT *, DB_LSN *, int, void *));
int CDB___bam_cadjust_recover __P ((DB_ENV *, DBT *, DB_LSN *, int, void *));
int CDB___bam_cdel_recover __P ((DB_ENV *, DBT *, DB_LSN *, int, void *));
int CDB___bam_repl_recover __P ((DB_ENV *, DBT *, DB_LSN *, int, void *));
