...
int CDB___bam_pgin __P((DB_ENV *, db_pgno_t, void *, DBT *));
int CDB___bam_pgout __P((DB_ENV *, db_pgno_t, void *, DBT *));
int CDB___bam_mswap __P((PAGE *));
void CDB___bam_cprint __P((DBC *));
int CDB___bam_ca_delete __P((DB *, db_pgno_t, u_int32_t, int));
int CDB___ram_ca_delete __P((DB *, db_pgno_t));
void CDB___bam_ca_di __P((DB *, db_pgno_t, u_int32_t, int));
int CDB___bam_ca_dup __P((DB *,
...
int CDB___bam_c_init __P((DBC *, DBTYPE));
int CDB___bam_c_refresh __P((DBC *));
int CDB___bam_c_count __P((DBC *, db_recno_t *));
int CDB___bam_c_dup __P((DBC *, DBC *));
int CDB___bam_c_rget __P((DBC *, DBT *, u_int32_t));
...
int CDB___bam_dpages __P((DBC *, EPG *));
...
int CDB___bam_open __P((DB *, const char *, db_pgno_t, u_int32_t));
int CDB___bam_metachk __P((DB *, const char *, BTMETA *));
int CDB___bam_read_root __P((DB *, const char *, db_pgno_t, u_int32_t));
int CDB___bam_iitem __P((DBC *, DBT *, DBT *, u_int32_t, u_int32_t));
...
int CDB___ram_open __P((DB *, const char *, db_pgno_t, u_int32_t));
int CDB___ram_c_del __P((DBC *));
int CDB___ram_c_get
    __P((DBC *, DBT *, DBT *, u_int32_t, db_pgno_t *));
int CDB___ram_c_put __P((DBC *, DBT *, DBT *, u_int32_t, db_pgno_t *));
...
int CDB___bam_stkrel __P((DBC *, u_int32_t));
int CDB___bam_stkgrow __P((DB_ENV *, BTREE_CURSOR *));
...
int CDB___bam_stat_callback __P((DB *, PAGE *, void *, int *));
int CDB___bam_key_range __P((DB *,
...
int CDB___bam_31_lbtree
     __P((DB *, char *, u_int32_t, DB_FH *, PAGE *, int *));
int CDB___bam_vrfy_meta __P((DB *, VRFY_DBINFO *, BTMETA *,
    db_pgno_t, u_int32_t));
int CDB___ram_vrfy_leaf __P((DB *, VRFY_DBINFO *, PAGE *, db_pgno_t,
    u_int32_t));
int CDB___bam_vrfy __P((DB *, VRFY_DBINFO *, PAGE *, db_pgno_t,
    u_int32_t));
int CDB___bam_vrfy_itemorder __P((DB *, VRFY_DBINFO *, PAGE *,
    db_pgno_t, u_int32_t, int, int, u_int32_t));
int CDB___bam_vrfy_structure __P((DB *, VRFY_DBINFO *, db_pgno_t,
    u_int32_t));
int CDB___bam_vrfy_subtree __P((DB *, VRFY_DBINFO *, db_pgno_t, void *,
    void *, u_int32_t, u_int32_t *, u_int32_t *, u_int32_t *));
int CDB___bam_salvage __P((DB *, VRFY_DBINFO *, db_pgno_t, u_int32_t,
    PAGE *, void *, int (*)(void *, const void *), DBT *,
    u_int32_t));
int CDB___bam_salvage_walkdupint __P((DB *, VRFY_DBINFO *, PAGE *,
    DBT *, void *, int (*)(void *, const void *), u_int32_t));
int CDB___bam_meta2pgset __P((DB *, VRFY_DBINFO *, BTMETA *,
    u_int32_t, DB *));
#if defined(__cplusplus)
}
#endif
