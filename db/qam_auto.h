...
int CDB___qam_inc_print __P((DB_ENV *, DBT *, DB_LSN *, db_recops, void *));
...
int CDB___qam_incfirst_print __P((DB_ENV *, DBT *, DB_LSN *, db_recops, void *));
int CDB___qam_incfirst_read __P((DB_ENV *, void *, __qam_incfirst_args **));
...
int CDB___qam_mvptr_print __P((DB_ENV *, DBT *, DB_LSN *, db_recops, void *));
int CDB___qam_mvptr_read __P((DB_ENV *, void *, __qam_mvptr_args **));
...
int CDB___qam_del_print __P((DB_ENV *, DBT *, DB_LSN *, db_recops, void *));
int CDB___qam_del_read __P((DB_ENV *, void *, __qam_del_args **));
...
int CDB___qam_add_print __P((DB_ENV *, DBT *, DB_LSN *, db_recops, void *));
int CDB___qam_add_read __P((DB_ENV *, void *, __qam_add_args **));
