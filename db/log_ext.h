...
int CDB___log_reopen_file __P((DB_ENV *,
    char *, int32_t, u_int8_t *, db_pgno_t));
int CDB___log_add_logid __P((DB_ENV *, DB_LOG *, DB *, int32_t));
int CDB___db_fileid_to_db __P((DB_ENV *, DB **, int32_t, int));
void CDB___log_close_files __P((DB_ENV *));
void CDB___log_rem_logid __P((DB_LOG *, DB *, int32_t));
int CDB___log_filelist_update
   __P((DB_ENV *, DB *, int32_t, const char *, int *));
int CDB___log_file_lock __P((DB *));
#if defined(__cplusplus)
}
#endif
#endif /* _log_ext_h_ */
