...
int
CDB___txn_old_regop_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___txn_old_regop_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___txn_old_regop_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__txn_old_regop_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__txn_old_regop_args) +
...
int
CDB___txn_regop_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
...
int
CDB___txn_regop_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__txn_regop_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__txn_regop_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___txn_old_ckp_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___txn_old_ckp_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___txn_old_ckp_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__txn_old_ckp_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__txn_old_ckp_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___txn_ckp_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
...
int
CDB___txn_ckp_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__txn_ckp_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__txn_ckp_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___txn_xa_regop_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
...
int
CDB___txn_xa_regop_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__txn_xa_regop_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__txn_xa_regop_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___txn_child_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
...
int
CDB___txn_child_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__txn_child_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__txn_child_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
	...
	DB_ENV *dbenv;
{
	...
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___txn_old_regop_print, DB_txn_old_regop)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___txn_regop_print, DB_txn_regop)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___txn_old_ckp_print, DB_txn_old_ckp)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	...
	DB_ENV *dbenv;
{
	...
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___deprecated_recover, DB_txn_old_regop)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___txn_regop_recover, DB_txn_regop)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___deprecated_recover, DB_txn_old_ckp)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
