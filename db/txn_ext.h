...
int CDB___txn_regop_recover __P ((DB_ENV *, DBT *, DB_LSN *, int, void *));
int CDB___txn_xa_regop_recover __P ((DB_ENV *, DBT *, DB_LSN *, int, void *));
int CDB___txn_ckp_recover __P ((DB_ENV *, DBT *, DB_LSN *, int, void *));
int CDB___txn_child_recover __P ((DB_ENV *, DBT *, DB_LSN *, int, void *));
