...
int
CDB___ham_insdel_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_insdel_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_insdel_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_insdel_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_insdel_args) +
...
int
CDB___ham_newpage_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_newpage_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_newpage_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_newpage_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_newpage_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___ham_splitmeta_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_splitmeta_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_splitmeta_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_splitmeta_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_splitmeta_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___ham_splitdata_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_splitdata_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_splitdata_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_splitdata_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_splitdata_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___ham_replace_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_replace_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_replace_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_replace_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_replace_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___ham_newpgno_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_newpgno_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_newpgno_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_newpgno_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_newpgno_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___ham_ovfl_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_ovfl_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_ovfl_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_ovfl_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_ovfl_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___ham_copypage_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_copypage_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_copypage_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_copypage_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_copypage_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___ham_metagroup_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_metagroup_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_metagroup_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_metagroup_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_metagroup_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___ham_groupalloc1_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_groupalloc1_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_groupalloc1_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_groupalloc1_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_groupalloc1_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
...
int
CDB___ham_groupalloc_print(dbenv, dbtp, lsnp, notused2, notused3)
	DB_ENV *dbenv;
	DBT *dbtp;
	DB_LSN *lsnp;
	db_recops notused2;
	void *notused3;
{
	...
	if ((ret = CDB___ham_groupalloc_read(dbenv, dbtp->data, &argp)) != 0)
		return (ret);
...
int
CDB___ham_groupalloc_read(dbenv, recbuf, argpp)
	DB_ENV *dbenv;
	void *recbuf;
	__ham_groupalloc_args **argpp;
{
	...
	ret = CDB___os_malloc(dbenv, sizeof(__ham_groupalloc_args) +
	    sizeof(DB_TXN), NULL, &argp);
	if (ret != 0)
		return (ret);
	argp->txnid = (DB_TXN *)&argp[1];
	...
	DB_ENV *dbenv;
{
	...
	if ((ret = CDB___db_add_recovery(dbenv,
		...
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___ham_groupalloc1_print, DB_ham_groupalloc1)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	...
	DB_ENV *dbenv;
{
	...
	if ((ret = CDB___db_add_recovery(dbenv,
		...
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___deprecated_recover, DB_ham_splitmeta)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	...
	if ((ret = CDB___db_add_recovery(dbenv,
		...
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___deprecated_recover, DB_ham_newpgno)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___deprecated_recover, DB_ham_ovfl)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	...
	if ((ret = CDB___db_add_recovery(dbenv,
		...
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
	    CDB___deprecated_recover, DB_ham_groupalloc1)) != 0)
		return (ret);
	if ((ret = CDB___db_add_recovery(dbenv,
