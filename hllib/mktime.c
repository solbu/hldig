                   ...
                   time_t * offset)
{
  ...
  int yday = ((__mon_yday[__isleap (year + TM_YEAR_BASE)]
               [mon_remainder + 12 * negative_mon_remainder]) + mday - 1);
     ...
     struct tm *b;
{
  return ((a->tm_sec ^ b->tm_sec)
          ...
          | (a->tm_year ^ b->tm_year)
          | (a->tm_mday ^ b->tm_mday)
          | (a->tm_yday ^ b->tm_yday) | (a->tm_isdst ^ b->tm_isdst));
}
     ...
     char **argv;
{
  ...
  if ((argc == 3 || argc == 4)
      ...
      && (sscanf (argv[2], "%d:%d:%d%c",
                  &tm.tm_hour, &tm.tm_min, &tm.tm_sec, &trailer) == 3))
  {
