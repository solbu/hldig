...
" },
{ "allow_numbers", "false", 
	"boolean", "htdig", "all", "Indexing:What", "allow_numbers: true", "
...
{ "bad_extensions", ".wav .gz .z .sit .au .zip .tar .hqx .exe .com .gif .jpg .jpeg .aiff .class .map .ram .tgz .bin .rpm .mpg .mov .avi", 
	"string list", "htdig", "all", "Indexing:Where", "bad_extensions: .foo .bar .bad", "
...
" },
{ "bad_querystr", "", 
	"pattern list", "htdig", "3.1.0", "Indexing:Where", "bad_querystr: forum=private section=topsecret&amp;passwd=required", "
...
{ "exclude_urls", "/cgi-bin/ .cgi", 
	"pattern list", "htdig", "all", "Indexing:Where", "exclude_urls: students.html cgi-bin", "
...
{ "head_before_get", "false", 
	"boolean", "htdig", "3.2.0b1", "Indexing:Connection", "head_before_get: true", "
...
" },
{ "http_proxy", "", 
	"string", "htdig", "3.0", "Indexing:Connection", "http_proxy: http://proxy.bigbucks.com:3128", "
...
{ "local_default_doc", "index.html", 
	"string list", "htdig", "3.0.8b2", "Indexing:Where", "local_default_doc: default.html default.htm index.html index.htm", "
...
{ "maintainer", "bogus@unconfigured.htdig.user", 
	"string", "htdig", "all", "Indexing:Out", "maintainer: ben.dover@uptight.com", "
...
" },
{ "max_doc_size", "100000", 
	"number", "htdig", "3.0", "Indexing:What", "max_doc_size: 5000000", "
...
{ "remove_bad_urls", "true", 
	"boolean", "htmerge", "all", "Indexing:How", "remove_bad_urls: true", "
...
{ "remove_unretrieved_urls", "false", 
	"boolean", "htmerge", "3.2.0b1", "Indexing:How", "remove_unretrieved_urls: true", "
...
{ "robotstxt_name", "htdig", 
	"string", "htdig", "3.0.7", "Indexing:Out", "robotstxt_name: myhtdig", "
...
" },
{ "server_max_docs", "-1", 
	"integer", "htdig", "3.1.0b3", "Indexing:Where", "server_max_docs: 50", "
...
" },
{ "server_wait_time", "0", 
	"integer", "htdig", "3.1.0b3", "Indexing:Connection", "server_wait_time: 20", "
...
" },
{ "timeout", "30", 
	"number", "htdig", "all", "Indexing:Connection", "timeout: 42", "
...
" },
{ "user_agent", "htdig", 
	"string", "htdig", "3.1.0b2", "Indexing:Out", "user_agent: htdig-digger", "
	This allows customization of the user_agent: field sent when
	the digger requests a file from a server.
" },
{ "valid_extensions", "", 
	"string list", "htdig", "3.1.4", "Indexing:Where", "valid_extensions: .html .htm .shtml", "
	This is a list of extensions on URLs which are
