...
//
// $Id: defaults.cc,v 1.65 2000/02/19 05:28:50 ghutchis Exp $
//
...
" },
{ "allow_in_form", "", 
	"string list", "htsearch", "3.1.0", "", "allow_in_form: search_algorithm search_results_header", "
...
" },
{ "allow_numbers", "false", 
	"boolean", "htdig", "all", "", "allow_numbers: true", "
...
{ "allow_virtual_hosts", "true", 
	"boolean", "htdig", "3.0.8b2", "", "allow_virtual_hosts: false", "
...
" },
{ "authorization", "", 
	"string", "htdig", "3.1.4", "", "authorization: myusername:mypassword", "
...
{ "backlink_factor", "1000", 
	"number", "htsearch", "3.1.0", "", "backlink_factor: 501.1", "
...
{ "bad_extensions", ".wav .gz .z .sit .au .zip .tar .hqx .exe .com .gif .jpg .jpeg .aiff .class .map .ram .tgz .bin .rpm .mpg .mov .avi", 
	"string list", "htdig", "all", "", "bad_extensions: .foo .bar .bad", "
...
{ "bad_word_list", "${common_dir}/bad_words", 
	"string", "htdig htsearch", "all", "", "bad_word_list: ${common_dir}/badwords.txt", "
...
" },
{ "bin_dir", BIN_DIR, 
	"string", "htdig htnotify htfuzzy htmerge htsearch", "all", "", "bin_dir: /usr/local/bin", "
...
" },
{ "build_select_lists", "", 
	"quoted string list", "htsearch", "3.2.0b1", "", "build_select_lists:
...
" },
{ "case_sensitive", "true", 
	"boolean", "htdig", "3.1.0b2", "", "case_sensitive: false", "
...
{ "common_dir", COMMON_DIR, 
	"string", "htdig htnotify htfuzzy htmerge htsearch", "all", "", "common_dir: /tmp", "
...
{ "common_url_parts", "http:// http://www. ftp:// ftp://ftp. /pub/ .html .htm .gif .jpg .jpeg /index.html /index.htm .com/ .com mailto:", 
	"string list", "htdig htnotify htmerge htsearch", "3.1.0", "", "common_url_parts: http://www.htdig.org/ml/ \\<br>
.html \\<br>
...
" },
{ "compression_level", "0", 
	"number", "htdig", "3.1.0", "", "compression_level: 6", "
...
{ "config_dir", CONFIG_DIR, 
	"string", "htdig htnotify htfuzzy htmerge htsearch", "all", "", "config_dir: /var/htdig/conf", "
...
{ "create_image_list", "false", 
	"boolean", "htdig", "all", "", "create_image_list: yes", "
...
{ "create_url_list", "false", 
	"boolean", "htdig", "all", "", "create_url_list: yes", "
...
{ "database_base", "${database_dir}/db", 
	"string", "htdig htnotify htfuzzy htmerge htsearch", "all", "", "database_base: ${database_dir}/sales", "
...
{ "database_dir", DATABASE_DIR, 
	"string", "htdig htnotify htfuzzy htmerge htsearch", "all", "", "database_dir: /var/htdig", "
...
{ "description_factor", "150", 
	"number", "htsearch", "3.1.0b3", "", "description_factor: 350", "
...
{ "doc_db", "${database_base}.docdb", 
	"string", "htdig htmerge htsearch", "all", "", "doc_db: ${database_base}documents.db", "
...
{ "doc_excerpt", "${database_base}.excerpts", 
	"string", "htdig htmerge htsearch", "3.2.0b1", "", "doc_excerpt: ${database_base}excerpts.db", "
...
{ "doc_index", "${database_base}.docs.index", 
	"string", "htmerge htdig", "all", "", "doc_index: documents.index.db", "
...
{ "doc_list", "${database_base}.docs", 
	"string", "htdig", "all", "", "doc_list: /tmp/documents.text", "
...
{ "end_ellipses", "<b><tt> ...</tt></b>", 
	"string", "htsearch", "all", "", "end_ellipses: ...", "
...
{ "end_highlight", "</strong>", 
	"string", "htsearch", "3.1.4", "", "end_highlight: &lt;/font&gt;", "
...
{ "endings_affix_file", "${common_dir}/english.aff", 
	"string", "htfuzzy", "all", "", "endings_affix_file: /var/htdig/affix_rules", "
...
{ "endings_dictionary", "${common_dir}/english.0", 
	"string", "htfuzzy", "all", "", "endings_dictionary: /var/htdig/dictionary", "
	Specifies the location of the file which contains the
...
{ "endings_root2word_db", "${common_dir}/root2word.db", 
	"string", "htfuzzy htsearch", "all", "", "endings_root2word_db: /var/htdig/r2w.db", "
...
{ "endings_word2root_db", "${common_dir}/word2root.db", 
	"string", "htfuzzy htsearch", "all", "", "endings_word2root_db: /var/htdig/w2r.bm", "
	This attributes specifies the database filename to be
	used in the 'endings' fuzzy search algorithm. The
...
" },
{ "excerpt_length", "300", 
	"number", "htsearch", "all", "", "excerpt_length: 500", "
...
{ "excerpt_show_top", "false", 
	"boolean", "htsearch", "all", "", "excerpt_show_top: yes", "
...
" },
{ "http_proxy", "", 
	"string", "htdig", "3.0", "", "http_proxy: http://proxy.bigbucks.com:3128", "
...
{ "image_list", "${database_base}.images", 
	"string", "htdig", "all", "", "image_list: allimages", "
...
{ "image_url_prefix", IMAGE_URL_PREFIX, 
	"string", "htsearch", "all", "", "image_url_prefix: /images/htdig", "
...
" },
{ "iso_8601", "false", 
	"boolean", "htsearch htnotify", "3.1.0b2", "", "iso_8601: true", "
...
" },
{ "keywords_factor", "100", 
	"number", "htsearch", "all", "", "keywords_factor: 12", "
	This is a factor which will be used to multiply the
...
{ "keywords_meta_tag_names", "keywords htdig-keywords", 
	"string list", "htdig", "3.0.6", "", "keywords_meta_tag_names: keywords description", "
...
" },
{ "logging", "false", 
	"boolean", "htsearch", "3.1.0b2", "", "logging: true", "
...
{ "maintainer", "bogus@unconfigured.htdig.user", 
	"string", "htdig", "all", "", "maintainer: ben.dover@uptight.com", "
...
" },
{ "match_method", "and", 
	"string", "htsearch", "3.0", "", "match_method: boolean", "
...
" },
{ "matches_per_page", "10", 
	"number", "htsearch", "3.0", "", "matches_per_page: 999", "
...
" },
{ "max_descriptions", "5", 
	"number", "htdig", "all", "", "max_descriptions: 15", "
	While gathering descriptions of URLs,
...
" },
{ "max_doc_size", "100000", 
	"number", "htdig", "3.0", "", "max_doc_size: 5000000", "
...
" },
{ "max_head_length", "512", 
	"number", "htdig", "all", "", "max_head_length: 50000", "
...
{ "max_hop_count", "999999", 
	"number", "htdig", "all", "", "max_hop_count: 4", "
...
{ "max_prefix_matches", "1000", 
	"integer", "htsearch", "3.1.0b1", "", "max_prefix_matches: 100", "
...
" },
{ "maximum_pages", "10", 
	"integer", "htsearch", "all", "", "maximum_pages: 20", "
...
{ "maximum_word_length", "32", 
	"number", "htdig htsearch", "3.1.3", "", "maximum_word_length: 15", "
...
{ "meta_description_factor", "50", 
	"number", "htsearch", "3.1.0b1", "", "meta_description_factor: 20", "
	This is a factor which will be used to multiply the
...
{ "metaphone_db", "${database_base}.metaphone.db", 
	"string", "htfuzzy htsearch", "all", "", "metaphone_db: ${database_base}.mp.db", "
...
{ "method_names", "and All or Any boolean Boolean", 
	"quoted string list", "htsearch", "all", "", "method_names: or Or and And", "
...
{ "minimum_speling_length", "5", 
	"number", "htsearch", "3.2.0b1", "", "minimum_speling_length: 3", "
...
{ "minimum_word_length", "3", 
	"number", "htdig htsearch", "all", "", "minimum_word_length: 2", "
...
" },
{ "next_page_text", "[next]", 
	"string", "htsearch", "3.1.0", "", "next_page_text: &lt;img src=\"/htdig/buttonr.gif\"&gt;", "
	The text displayed in the hyperlink to go to the next
	page of matches.
" },
{ "no_excerpt_show_top", "false", 
	"boolean", "htsearch", "3.1.0b3", "", "no_excerpt_show_top: yes", "
...
{ "no_excerpt_text", "<em>(None of the search words were found in the top of this document.)</em>", 
	"string", "htsearch", "3.0", "", "no_excerpt_text:", "
...
{ "no_next_page_text", "[next]", 
	"string", "htsearch", "3.0", "", "no_next_page_text:", "
	The text displayed where there would normally be a
	hyperlink to go to the next page of matches.
" },
{ "no_page_list_header", "", 
	"string", "htsearch", "3.0", "", "no_page_list_header: &lt;hr noshade size=2&gt;All results on this page.&lt;br&gt;", "
...
" },
{ "no_page_number_text", "", 
	"quoted string list", "htsearch", "3.0", "", "no_page_number_text:
...
{ "no_prev_page_text", "[prev]", 
	"string", "htsearch", "3.0", "", "no_prev_page_text:", "
	The text displayed where there would normally be a
	hyperlink to go to the previous page of matches.
" },
{ "no_title_text", "filename", 
	"string", "htsearch", "3.1.0", "", "no_title_text: \"No Title Found\"", "
...
{ "noindex_end", "<!--/htdig_noindex-->", 
	"string", "htdig", "3.1.0", "", "noindex_end: &lt;/SCRIPT&gt;", "
...
{ "noindex_start", "<!--htdig_noindex-->", 
	"string", "htdig", "3.1.0", "", "noindex_start: &lt;SCRIPT", "
...
{ "nothing_found_file", "${common_dir}/nomatch.html", 
	"string", "htsearch", "all", "", "nothing_found_file: /www/searching/nothing.html", "
...
{ "page_list_header", "<hr noshade size=2>Pages:<br>", 
	"string", "htsearch", "3.0", "", "page_list_header:", "
	This text will be used as the value of the PAGEHEADER
	variable, for use in templates or the
	<a href=\"#search_results_footer\">search_results_footer</a>
...
{ "page_number_separator", "\" \"", 
	"quoted string list", "htsearch", "3.1.4", "", "page_number_separator: \"&lt;/td&gt; &lt;td&gt;\"", "
	The text strings in this list will be used when putting
	together the PAGELIST variable, for use in templates or
	the <a href=\"#search_results_footer\">search_results_footer</a>
	file, when search results fit on more than page. The PAGELIST
...
" },
{ "page_number_text", "", 
	"quoted string list", "htsearch", "3.0", "", "page_number_text:
				  &lt;em&gt;1&lt;/em&gt; &lt;em&gt;2&lt;/em&gt; \\<br>
				  &lt;em&gt;3&lt;/em&gt; &lt;em&gt;4&lt;/em&gt; \\<br>
				  &lt;em&gt;5&lt;/em&gt; &lt;em&gt;6&lt;/em&gt; \\<br>
				  &lt;em&gt;7&lt;/em&gt; &lt;em&gt;8&lt;/em&gt; \\<br>
...
{ "pdf_parser", PDF_PARSER " -toPostScript", 
	"string", "htdig", "3.1.0b1", "", "pdf_parser: /usr/local/Acrobat3/bin/acroread -toPostScript -pairs", "
...
" },
{ "prev_page_text", "[prev]", 
	"string", "htsearch", "3.0", "", "prev_page_text: &lt;img src=\"/htdig/buttonl.gif\"&gt;", "
	The text displayed in the hyperlink to go to the
	previous page of matches.
" },
{ "regex_max_words", "25", 
	"number", "htsearch", "3.2.0b1", "", "regex_max_words: 10", "
...
{ "remove_bad_urls", "true", 
	"boolean", "htmerge", "all", "", "remove_bad_urls: true", "
...
{ "remove_default_doc", "index.html", 
	"string list", "htdig", "3.1.0", "", "remove_default_doc: default.html default.htm index.html index.htm", "
	Set this to the default documents in a directory used by the
...
" },
{ "script_name", "", 
	"string", "htsearch", "3.1.4", "", "script_name: /search/results.shtml", "
...
{ "search_algorithm", "exact:1", 
	"string list", "htsearch", "all", "", "search_algorithm: exact:1 soundex:0.3", "
...
{ "search_results_footer", "${common_dir}/footer.html", 
	"string", "htsearch", "all", "", "search_results_footer: /usr/local/etc/ht/end-stuff.html", "
...
{ "search_results_header", "${common_dir}/header.html", 
	"string", "htsearch", "all", "", "search_results_header: /usr/local/etc/ht/start-stuff.html", "
...
{ "search_results_wrapper", "", 
	"string", "htsearch", "3.1.0", "", "search_results_wrapper: ${common_dir}/wrapper.html", "
...
" },
{ "server_aliases", "", 
	"string list", "htdig", "3.1.0b2", "", "server_aliases:
...
" },
{ "server_max_docs", "-1", 
	"integer", "htdig", "3.1.0b3", "", "server_max_docs: 50", "
...
" },
{ "server_wait_time", "0", 
	"integer", "htdig", "3.1.0b3", "", "server_wait_time: 20", "
...
" },
{ "sort", "score", 
	"string", "htsearch", "3.1.0", "", "sort: revtime", "
...
{ "sort_names", "score Score time Time title Title revscore 'Reverse Score' revtime 'Reverse Time' revtitle 'Reverse Title'", 
	"quoted string list", "htsearch", "3.1.0", "", "sort_names:
...
{ "soundex_db", "${database_base}.soundex.db", 
	"string", "htfuzzy htsearch", "all", "", "soundex_db: ${database_base}.snd.db", "
...
{ "star_blank", "${image_url_prefix}/star_blank.gif", 
	"string", "htsearch", "all", "", "star_blank: http://www.somewhere.org/icons/elephant.gif", "
...
{ "star_image", "${image_url_prefix}/star.gif", 
	"string", "htsearch", "all", "", "star_image: http://www.somewhere.org/icons/elephant.gif", "
...
" },
{ "star_patterns", "", 
	"string list", "htsearch", "3.0", "", "star_patterns:
...
{ "start_ellipses", "<b><tt>... </tt></b>", 
	"string", "htsearch", "all", "", "start_ellipses: ...", "
	When excerpts are displayed in the search output, this
...
{ "start_highlight", "<strong>", 
	"string", "htsearch", "3.1.4", "", "start_highlight: &lt;font color=\"#FF0000\"&gt;", "
	When excerpts are displayed in the search output, matched
...
{ "start_url", "http://www.htdig.org/", 
	"string list", "htdig", "all", "", "start_url: http://www.somewhere.org/alldata/index.html", "
...
{ "substring_max_words", "25", 
	"integer", "htsearch", "3.0.8b1", "", "substring_max_words: 100", "
...
{ "synonym_db", "${common_dir}/synonyms.db", 
	"string", "htsearch htfuzzy", "3.0", "", "synonym_db: ${database_base}.syn.db", "
...
{ "synonym_dictionary", "${common_dir}/synonyms", 
	"string", "htfuzzy", "3.0", "", "synonym_dictionary: /usr/dict/synonyms", "
...
{ "syntax_error_file", "${common_dir}/syntax.html", 
	"string", "htsearch", "all", "", "syntax_error_file: ${common_dir}/synerror.html", "
...
{ "template_map", "Long builtin-long builtin-long Short builtin-short builtin-short", 
	"string list", "htsearch", "3.0", "", "template_map:
...
{ "template_name", "builtin-long", 
	"string", "htsearch", "3.0", "", "template_name: long", "
...
" },
{ "template_patterns", "", 
	"string list", "htsearch", "3.1.4", "", "template_patterns:
...
" },
{ "text_factor", "1", 
	"number", "htsearch", "3.0", "", "text_factor: 0", "
	This is a factor which will be used to multiply the
...
" },
{ "title_factor", "100", 
	"number", "htsearch", "all", "", "title_factor: 12", "
	This is a factor which will be used to multiply the
...
" },
{ "translate_amp", "false", 
	"boolean", "htdig htsearch", "3.1.0", "", "translate_amp: true", "
...
{ "translate_lt_gt", "false", 
	"boolean", "htdig htsearch", "3.1.0", "", "translate_lt_gt: true", "
...
{ "translate_quot", "false", 
	"boolean", "htdig htsearch", "3.1.0", "", "translate_quot: true", "
	If set to false, the entity &amp;quot; (or &amp;#34;) will not be
	translated into its ASCII equivalent &quot;. If translation were taking
	place, an excerpt containing a &quot; might be misinterpreted by the browser
	and look unrecognizable to the user. For this reason, not translating this
...
{ "uncoded_db_compatible", "true", 
	"boolean", "htdig htnotify htmerge htsearch", "3.1.0", "", "uncoded_db_compatible: false<p>", "
...
{ "url_log", "${database_base}.log", 
	"string", "htdig", "3.1.0", "", "url_log: /tmp/htdig.progress", "
...
" },
{ "url_part_aliases", "", 
	"string list", "htdig htnotify htmerge htsearch", "3.1.0", "", "url_part_aliases:
...
" },
{ "use_doc_date", "false", 
	"boolean", "htdig", "3.2.0b1", "", "use_doc_date: true", "
...
{ "use_meta_description", "false", 
	"boolean", "htsearch", "3.1.0b1", "", "use_meta_description: true", "
...
" },
{ "use_star_image", "true", 
	"boolean", "htsearch", "all", "", "use_star_image: no", "
...
" },
{ "user_agent", "htdig", 
	"string", "htdig", "3.1.0b2", "", "user_agent: htdig-digger", "
	This allows customization of the user_agent: field sent when
	the digger requests a file from a server.
" },
{ "valid_extensions", "", 
	"string list", "htdig", "3.1.4", "", "valid_extensions: .html .htm .shtml", "
	This is a list of extensions on URLs which are
...
" },
{ "valid_punctuation", ".-_/!#$%^&'", 
	"string", "htdig htsearch", "all", "", "valid_punctuation: -'", "
...
" },
{ "version", VERSION, 
	"string", "htsearch", "version: 3.2.0", "all", "", "
...
{ "word_db", "${database_base}.words.db", 
	"string", "htdig htmerge htsearch", "all", "", "word_db: ${database_base}.allwords.db", "
...
{ "word_dump", "${database_base}.worddump", 
	"string", "htdig", "3.2.0b1", "", "word_dump: /tmp/words.txt", "
	This file is basically a text version of the file
...
{ "word_list", "${database_base}.wordlist", 
	"string", "htdig htmerge", "all", "", "word_list: ${database_base}.allwords.text", "
...
{ "wordlist_compress", "false", 
	"boolean", "htdig htmerge htsearch htfuzzy", "3.2.0b1", "", "wordlist_compress: true", "
...
{ "wordlist_page_size", "0", 
	"number", "htdig htmerge htsearch htfuzzy", "3.2.0b1", "", "wordlist_page_size: 8192", "
	Size of pages used by Berkeley DB (DB used by the indexer)
" },
{ "wordlist_cache_size", "10000000", 
	"number", "htdig htmerge htsearch htfuzzy", "3.2.0b1", "", "wordlist_cache_size: 40000000", "
...
{ "wordlist_compress_debug", "0", 
	"number", "htdig htmerge htsearch htfuzzy", "3.2.0b1", "", "wordlist_compress_debug: 2", "
...
{ "wordlist_wordkey_description", "nfields: 4/Location 16 3/Flags 8 2/DocID 32 1/Word 0 0",
	"string", "htdig htmerge htsearch htfuzzy", "3.2.0b1", "", "**this should not be configured by user**", "
...
{ "wordlist_monitor", "false",
	"boolean", "htdig htmerge htsearch htfuzzy", "3.2.0b1", "", "wordlist_monitor: true", "
...
{ "wordlist_monitor_period","1.0",
	"string", "htdig htmerge htsearch htfuzzy", "3.2.0b1", "", "wordlist_monitor_period: .1", "
...
{ "wordlist_monitor_fields","totput put/s cmpr/s ucmpr/s put_time cmpr_ucmpr_time",
	"string", "htdig htmerge htsearch htfuzzy", "3.2.0b1", "", "wordlist_monitor_fields: put/s nwalks/s", "
...
{ "wordlist_monitor_output","1.0",
	"string", "htdig htmerge htsearch htfuzzy", "3.2.0b1", "", "wordlist_monitor_output: file:/home/bosc/trash/wlmonout", "
